...
目前完成 PWA 基礎、離線成語資料、第一章 20 關填字闖關、關卡地圖、星級與 IndexedDB 本機進度保存；自由接龍保留為附加模式，並加入可自行啟動的 15 秒成語打地鼠獎勵關卡、選用的網路收音機與 YouTube 影音中心，以及完成第 5 關後可選擇的候選偽字陷阱模式。
